...
import com.zhuzhuhe.tools.service.ThumbnailsService;
...
public class ThumbnailsServiceImpl implements ThumbnailsService {
     ...
     */
    @Override
    public String changeSize(String resource, int width, int height, String tofile) {
        try {
     ...
     */
    @Override
    public String changeScale(String resource, double scale, String tofile) {
        try {
     ...
     */
    @Override
    public String watermark(String resource, Positions p, String shuiyin, float opacity, String tofile) {
        try {
     ...
     */
    @Override
    public String rotate(String resource, double rotate, String tofile) {
        try {
     ...
     */
    @Override
    public String region(String resource, Positions p, int width, int height, String tofile) {
        try {
